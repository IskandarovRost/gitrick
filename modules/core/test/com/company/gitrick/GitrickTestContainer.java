...
public class GitrickTestContainer extends TestContainer {

    public GitrickTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/gitrick/app.properties",
    ...
    public static class Common extends GitrickTestContainer {

        public static final GitrickTestContainer.Common INSTANCE = new GitrickTestContainer.Common();
